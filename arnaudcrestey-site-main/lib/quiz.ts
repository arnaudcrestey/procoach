...
summary:"Vous êtes resté trop longtemps dans un environnement qui ne correspond plus à votre évolution.",
vigilance:[
...
summary:"Vos capacités sont supérieures aux opportunités offertes par votre poste actuel.",
vigilance:[
...
summary:"Vous êtes dans une période charnière où des décisions importantes doivent être prises.",
vigilance:[
...
summary:"Votre travail ne correspond plus à vos valeurs profondes.",
vigilance:[
...
summary:"Votre trajectoire semble globalement alignée avec votre personnalité.",
vigilance:[
"Rester en mouvement",
